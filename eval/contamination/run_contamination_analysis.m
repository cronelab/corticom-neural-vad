...
function []=run_contamination_analysis(out_path, prepared_path, timings_path, toolbox_path)
    ...
    %% Global parameters
    days = ["2022_11_18" "2022_11_29" "2022_11_30" "2022_12_15" "2022_12_16" "2023_01_03" "2023_01_05" "2023_01_10" "2023_01_12" "2023_01_13"];
    for i = 1:length(days)

        day = days(i);
        disp(strcat('Processing day: ', day));

        brain_matfile_path =  strcat(prepared_path, '/', day, '_50word_Overt_ecog.mat');
        audio_matfile_path =  strcat(prepared_path, '/', day, '_50word_Overt_audio.mat');
        timings_matlab_file = strcat(timings_path, '/', day, '_50word_Overt_timings.mat');
